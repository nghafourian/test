...
*Here we assume you have already installed `Anaconda 3` using the ([Anaconda manual](https://github.com/Shenavar/Anaconda-Installation.md/blob/master/Anaconda Installation.md)).*
